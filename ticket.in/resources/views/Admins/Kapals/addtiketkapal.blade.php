    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 mb-2">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item">Create Ticket Ship</li>
                </ol>
            </div>
        </div>
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Create Data Ticket Ship</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route('inserttiketkapal') }}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        ...
                        @foreach ($data_kapal as $row)
                            <option value="{{ $row->id }}">{{ $row->nama_kapal }}</option>
                        @endforeach
                        </select>
                    </div>
                    <div class="form-group">
