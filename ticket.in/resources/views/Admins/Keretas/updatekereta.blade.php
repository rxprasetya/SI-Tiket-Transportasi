    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 mb-2">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item">Update Trains</li>
                </ol>
            </div>
        </div>
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Update Data Train</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route('updatekereta', $data->id) }}" method="POST">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="{{ $data->tempat_duduk_kereta }}"
