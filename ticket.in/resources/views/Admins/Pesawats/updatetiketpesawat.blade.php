...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route('updatetiketpesawat', $data->id) }}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <option value="{{ $row->id }}" {{ $row->id == $data->id_maskapai ? 'selected' : '' }}>{{ $row->nama_maskapai }}</option>
                        @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="{{ $data->harga_tiket_pesawat }}"
